...
\author{Hannes Marien \newline Torsten Noack \newline Hans Meyer \newline FlyHinotori | \url{https://github.com/FlyHinotori}
\date{\today}
%%%%%%%%%%%%%%%
